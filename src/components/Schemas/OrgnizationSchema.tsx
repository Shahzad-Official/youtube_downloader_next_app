...
function OrgnizationSchema() {
  return (
    ...
    <script type="application/ld+json">
      ...
      "description": "Unlock a world of free entertainment and knowledge with our YouTube downloader. Download videos, shorts, and audio effortlessly in various resolutions.",
      "sameAs": [
